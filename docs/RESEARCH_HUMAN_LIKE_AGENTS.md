...
- 文学中的越界抉择暴露出“价值一致性过强”也会显得不真实。MVP-6 用冲动压力、社会易感性和自我许可表示诱惑、施压与合理化；对应机制消融必须重新出现预测失败，避免只增加无法证伪的心理名词。

## 评价和负面对照

MVP-6 保留六维总分，在 `ai_human_likeness` 中加入：
...
将 MVP-3、MVP-4、MVP-5、MVP-6、真人脚本和随机/平坦对照混排，评价角色一致、自然程度、情绪因果、
