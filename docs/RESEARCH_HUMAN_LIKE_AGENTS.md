...
MVP-7 保留六维总分，在 `ai_human_likeness` 中加入：
...
将 MVP-3、MVP-4、MVP-5、MVP-6、MVP-7、真人脚本和随机/平坦对照混排，评价角色一致、自然程度、情绪因果、
社会理解、决策可信、故事吸引力和是否愿意继续互动；不能只问“你觉得它是不是人”。

著名文学、影视与传记人物只构成另一条 `character_reference_fidelity` 证据链。内置 25 例原型集使用原创转述、无剧本/字幕/对白或传记段落，并把虚构人物与传记人物分轨；传记叙述仍不是行为遥测。其高分只能说明当前机制能重现这些设计卡，不能替代真实玩家实验。数据、版权门禁、负面对照、跨作品留出和校准状态见 [人物决策参考校准](NARRATIVE_CHARACTER_CALIBRATION.md)。
